//
//  Search_Location_ViewController.swift
//  Final_Project
//
...
class Search_Location_ViewController: UIViewController, GMSMapViewDelegate, CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        coord = CLLocationCoordinate2D(latitude: User.U_Lat, longitude: User.U_Long)
